...

  {
    ...
    children: [
      ...
      },
      {
        path: 'treeCKEditor5',
        name: 'TreeCKEditor5',
        component: () => import('@/views/treeCKEditor5/index'),
        meta: { title: 'TreeCKEditor5', icon: 'tree' }
      },
      {
        path: 'handsontable',
        name: 'Handsontable',
        component: () => import('@/components/Handsontable/handsontable'),
        meta: { title: 'Handsontable', icon: 'tree' }
      }
    ]
  },
  {
